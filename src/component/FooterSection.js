...
const UniCardsLogo = "https://uni.cards/images/pcidss_cert.svg";

const FooterSection = () => {
    return (
        <section>
            <div className="relative w-full" style={{ backgroundColor: "rgba(34, 34, 34, 1)" }}>
                <div className="flex items-center justify-center p-4 " style={{ color: "rgba(141, 141, 149, 1)" }}>
            ...
            <footer
                className="flex flex-col items-center text-white pt-[30px] px-4 md:px-14 md:pt-[50px] pb-40"
                id="footer"
                style={{
                    '--tw-bg-opacity': 1,
                        ...
                        <div className="flex flex-col w-full lg:w-1/2 items-start">
                            ...
                            <div className="text-grey-dark text-[13px] lg:text-base">
                                <p className="text-left w-full sm:w-[400px] md:w-[280px] lg:[w-360px]">
                                    Indiqube Sigma No.3/B, Nexus Koramangala 3rd Block SBI Colony, Koramangala,
                                ...
                                <p className="text-left w-full sm:w-[400px] md:w-[280px] lg:[w-360px]">
                                    Email:
                                    <a href="mailto:care@uni.club">care@uni.club</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex w-full max-w-[1240px] flex-col justify-center md:flex-row md:justify-between">
                    <div className="flex w-full flex-wrap flex-1 justify-center md:justify-start">
                        <div className="h-10 w-30">
                            <a className="py-0 px-[18px] h-[60px]" href="https://www.instagram.com/uni_cards/" target="_blank" rel="noopener noreferrer">
                                Instagram
                            </a>
                            <img width="6px" height="6px" src="https://uni.cards/images/footer-arrow.png" alt="arrow" className="css-0" />
                        </div>
                        <div className="h-10 w-30">
                            <a className="py-0 px-[18px] h-[60px]" href="https://www.linkedin.com/company/uni-cards" target="_blank" rel="noopener noreferrer">
                                LinkedIn
                            </a>
                            <img width="6px" height="6px" src="https://uni.cards/images/footer-arrow.png" alt="arrow" className="css-0" />
                        </div>
                        <div className="h-10 w-30">
                            <a className="py-0 px-[18px] h-[60px]" href="https://twitter.com/cards_uni" target="_blank" rel="noopener noreferrer">
                                Twitter
                            </a>
                            <img width="6px" height="6px" src="https://uni.cards/images/footer-arrow.png" alt="arrow" className="css-0" />
                        </div>
                        <div className="h-10 w-30">
                            <a className="py-0 px-[18px] h-[60px]" href="https://www.facebook.com/Uni-Cards-104179288358904" target="_blank" rel="noopener noreferrer">
                                Facebook
                            </a>
                            <img width="6px" height="6px" src="https://uni.cards/images/footer-arrow.png" alt="arrow" className="css-0" />
                        </div>
                        <div className="h-10 w-30">
                            <a className="py-0 px-[18px] h-[60px]" href="https://careers.uni.cards/" target="_blank" rel="noopener noreferrer">
                                Careers
                            </a>
                            <img width="6px" height="6px" src="https://uni.cards/images/footer-arrow.png" alt="arrow" className="css-0" />
                        </div>
                    ...
                    <div className="p-0 pb-5 flex justify-center flex-wrap">
                        <span data-testid="cc-kfs">
                            <a className="h-[60px]" href="https://uni.cards/credit-card-key-facts" target="_blank">
                                Credit Card KFS
                            </a>
                            <span className="px-2">|</span>
                        </span>
                        <span data-testid="nxwave-tnc">
                            <a className="h-[60px]" href="/docs/Credit_Card_MITC.pdf" target="_blank">
                                Credit Card T&Cs
                            </a>
                            <span className="px-2">|</span>
                        </span>
